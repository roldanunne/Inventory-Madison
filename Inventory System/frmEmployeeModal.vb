Public Class frmEmployeeModal
    ...
    Private Sub frmEmployeeModal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ElseIf empModalTask = "EDIT" Then
            ...
            Dim access As String() = empModalRow.Cells("user_access").Value.ToString.Split(New Char() {","c})
            Dim item As String
    ...
    Private Sub btnEmployee_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEmployee.Click
        ...
        ElseIf empModalTask = "EDIT" Then
            ...
            Else
                ...
                If result Then
                    picProfile.Image.Save(profilePath & "\" & empModalID & ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg)
                    frmEmployee1.loadDataEmployee()
                    Me.Close()
                Else
