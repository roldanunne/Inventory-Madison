Public Class frmSupplier
    ...
    Private Sub dgvEmployee_CellClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvEmployee.CellClick
        If e.RowIndex >= 0 Then
            ...
            Dim access As String() = empRow.Cells("user_access").Value.ToString.Split(New Char() {","c})
            Dim item As String
    ...
    Private Sub btnDeleteEmployee_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeleteEmployee.Click
        If empID = 1 Then
    ...
    Private Sub txtSearch_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeleteEmployee.TextChanged
